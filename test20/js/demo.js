$(document).ready(function(){
    ...
    $(".pic1").hover(function(){
         $(".pic1-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb1.png)");
    });
    $(".pic21").hover(function(){
         $(".pic21-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb2.png)");
    });
    $(".pic22").hover(function(){
         $(".pic22-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb3.png)");
    });
    $(".pic31").hover(function(){
         $(".pic31-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb4.png)");
    });
    $(".pic32").hover(function(){
         $(".pic32-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb5.png)");
    });
    $(".pic33").hover(function(){
         $(".pic33-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb6.png)");
    });
    $(".pic41").hover(function(){
         $(".pic41-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb7.png)");
    });
    $(".pic42").hover(function(){
         $(".pic42-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb8.png)");
    });
    $(".pic43").hover(function(){
         $(".pic43-font").toggle();
         $(".b-rig1").css("background-image","url(./css/bb9.png)");
    });
        //点击事件
        var bgArr = [{
            value: "url(./css/baidubg1.jpg)"
        },{ value: "url(./css/baidubg2.jpg)"
        },{ value: "url(./css/baidubg3.jpg)"
        },{ value: "url(./css/baidubg4.jpg)"
        },{ value: "url(./css/baidubg5.jpg)"
        },{ value: "url(./css/baidubg6.jpg)"
        },{ value: "url(./css/baidubg7.jpg)"
        },{ value: "url(./css/baidubg8.jpg)"
        },{ value: "url(./css/baidubg9.jpg)"
        }];
